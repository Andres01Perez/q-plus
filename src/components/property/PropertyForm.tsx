...
import { Save, Loader2, FileText, MapPin, Image, Layers, ChevronRight } from "lucide-react";
...
const TABS = ["basic", "location", "details", "media"] as const;
...
export function PropertyForm({ propertyId }: PropertyFormProps) {
  ...
  const isLastTab = activeTab === "media";
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as TabValue)} className="w-full">
          ...
          <div className="mt-6">
            ...
            <TabsContent value="media" className="mt-0 space-y-6">
              ...
              />
              {/* No continue button on last tab - user uses header save button */}
              <div className="flex justify-end pt-4 border-t">
                <Button type="submit" disabled={isSaving || !formData.title.trim()} className="gap-2">
                  {isSaving ? (
                    <>
